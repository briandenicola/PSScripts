...
function Enable-Features 
{
    ...
    #BUG - Currently does not log the output of the script to $global:log_file because this is launched as another powershell.exe process which is required to get away from type mapping issues.
    Set-Location ( Join-Path -Path $app_home -Child "ScriptBlocks" )
